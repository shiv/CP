...
public:
    ...
    public:
        ...
        // set initial values (_val is initial value of node and _lazy is identity for lazy operation)
        node(int _val = 0, int _lazy = -1) : val(_val), lazy(_lazy) {}
