...
public:
    ...
    node unite(node a, node b) const {
        node res;

        int a_last = a.sign ^ (a.len & 1 ^ 1);
        ...
        else if (a_last == b.sign) {
            res.len = abs(a.len - b.len);
            if (a.len > b.len) {
                res.sign = a.sign;
            }
            else {
                res.sign = b.sign ^ (min(a.len, b.len) & 1);
            }
        }
        ...
        // // node c = a;
        // if (a.val.first & 1 ^ 1) {
        //     a.val.second = -a.val.second;
        // }

        // if (a.val.first == 0) {
        //     res = b;
        // }
        // else if (b.val.first == 0) {
        //     res = a;
        // }
        // else if (a.val.second != b.val.second) {
        //     res.val.first = a.val.first + b.val.first;
        //     res.val.second = a.val.second;
        // }
        // else  {
        //     res.val.first = abs(a.val.first - b.val.first);
        //     if (a.val.first > b.val.first) {
        //         res.val.second = a.val.second;
        //     }
        //     else {
        //         res.val.second = b.val.second;
        //     }
        // }
