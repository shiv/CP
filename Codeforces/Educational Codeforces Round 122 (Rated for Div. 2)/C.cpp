...
void solve() {
    ...
    auto check = [&] (int hc, int dc, int hm, int dm) {
        int chances_for_mons = (hc + dm - 1) / dm;
        int chances_for_char = (hm + dc - 1) / dc;
        if (chances_for_char <= chances_for_mons) {
            return true;
        }
        return false;
    };
...
// int chances = (hc + dm - 1) / dm;
// if (hm <= chances * dc) win;
